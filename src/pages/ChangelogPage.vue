        ...
        <div v-else class="relative">
          ...
          <div class="space-y-4 md:space-y-6">
            ...
            >
              ...
              <!-- Release Card -->
              <div class="bg-surface0 rounded-2xl p-4 md:p-6 hover:bg-surface0/80 transition-colors">
                <!-- Header -->
                ...
                <div 
                  ...
                  :class="expandedRelease === index ? 'max-h-[5000px]' : 'max-h-32'"
                >
                ...
                <button 
                  v-if="release.body && release.body.length > 200"
                ...
                <!-- Download Link -->
                <div class="mt-4 pt-4 border-t border-surface1 flex flex-wrap gap-3">
                  <a 
